...
rules 로드 순서·R-01~R-09 coding-style.md 매핑 테이블·§9 안티 패턴 횡단 체크·rust-security-style.md 보완 기준·rust-test-style.md 보완 기준은 `../code-review-rust/SKILL.md`의 STEP 2를 그대로 따른다.
