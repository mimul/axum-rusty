...
**`coding-style.md`를 1차 판단 기준**으로, `security.md`·`security-rust.md`·`test-style.md`를 보완 기준으로 적용한다.
...
- **security.md + security-rust.md 보완 적용** — R-04·R-05·R-09 판단 시 보안 규칙을 추가 기준으로 적용
- **test-style.md 보완 적용** — R-08 판단 시 테스트 규칙의 커버리지·네이밍 기준 적용
...
/code-review-feedback-rust --scope security          R-09 보안 (security.md + security-rust.md 전체 기준 집중 분석)
...
rules 로드 순서·R-01~R-09 coding-style.md 매핑 테이블·§9 안티 패턴 횡단 체크·security.md 보완 기준·test-style.md 보완 기준은 `../code-review-rust/SKILL.md`의 STEP 2를 그대로 따른다.
...
🚫 Blocking Issues ([N]건)
  • [R-XX] [파일명:행번호] [이슈 제목]
    ...
    / 보완 근거: [security.md §섹션 또는 test-style.md §섹션] (해당 시)
...
📐 coding-style.md §5.3: 에러는 무시하지 않고 명확하게 전달하거나 처리한다
🔒 보완: security.md §5 에러&로그 + security-rust.md §6 에러 처리 (보안 관련 시)
───────────────────────────────────────
...
> 1차 기준: coding-style.md (도메인 중심 진화형 코딩 원칙)
> 보완 기준: security.md · test-style.md

### 🚫 Blocking Issues
- **[R-XX]** `[파일:행]` [이슈 제목]: [설명] / 📐 coding-style.md §[섹션]
...
| `../../rules/security-rust.md` | 보안 규칙 (Rust 전용) — R-04·R-05·R-09 Rust 특화 보완 | **STEP 2 분석 시작 전 로드 (3순위)** |
| `../../rules/test-style.md` | 테스트 규칙 — R-08 보완 기준 | **STEP 2 분석 시작 전 로드 (4순위)** |
