...
**`coding-style.md`를 1차 판단 기준**으로, `security.md`·`security-rust.md`·`rust-test-style.md`를 보완 기준으로 적용한다.
...
rules 로드 순서·R-01~R-09 coding-style.md 매핑 테이블·§9 안티 패턴 횡단 체크·security.md 보완 기준·rust-test-style.md 보완 기준은 `../code-review-rust/SKILL.md`의 STEP 2를 그대로 따른다.
...
🚫 Blocking Issues ([N]건)
  • [R-XX] [파일명:행번호] [이슈 제목]
    ...
    / 보완 근거: [security.md §섹션 또는 rust-test-style.md §섹션] (해당 시)
...
> 보완 기준: security.md · rust-test-style.md
