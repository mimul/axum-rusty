...
description: >
  ...
  STEP 2 타당성 평가 시 coding-style.md(도메인 중심 진화형 코딩 원칙)를 1차 판단 기준으로, security.md·security-rust.md·rust-test-style.md를 보완 기준으로 적용한다.
...
2. **coding-style.md(1차) · security.md · security-rust.md · rust-test-style.md(보완) 로드** 후 각 지적의 타당성 독립 평가
...
- **보완 기준** — security.md·security-rust.md(R-04·R-05·R-09)·rust-test-style.md(R-08)를 해당 카테고리 판단 시 추가 적용한다
...
[A-RV-XX] ✅ 대응
  ...
  보완: [R-XX 위반 / security.md §섹션 / rust-test-style.md §섹션] (해당 시)
...
📏 보완:   [security.md §섹션 / rust-test-style.md §섹션] (해당 시)
...
- 판단의 우선순위: **coding-style.md(1차) → security.md·security-rust.md·rust-test-style.md(보완) → CLAUDE.md 컨벤션**
...
- coding-style.md 원칙 및 `security.md`, `rust-test-style.md` 규칙과 충돌하는 리뷰어 제안은 해당 규칙을 우선한다
