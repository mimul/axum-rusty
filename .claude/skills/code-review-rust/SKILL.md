...
4. `.claude/rules/rust-test-style.md` — R-08 보완 기준
...
📏 보완:   [해당 시 — security.md §섹션 또는 rust-test-style.md §섹션]
...
> 보완 기준: .claude/rules/security.md · .claude/rules/rust-test-style.md
> 리뷰 대상: [파일 목록]
...
**[R-XX] [제목]** — `[파일명:행번호]`
[설명] / 근거: [security.md §섹션 또는 rust-test-style.md §섹션]
