...
impl NewUserBuilder {
    pub fn new() -> Self {
        Self {
            ...
            password_hash: "$2b$12$fixedhashfortest".to_string(), // 실제 시크릿 금지 (security.md §비밀 정보 관리)
...
**금지 (§1.5, §13)**
```rust
// ❌ 픽스처에 실제 시크릿 하드코딩 (security.md §비밀 정보 관리)
...
📏 규칙:       [rust-test-style.md §섹션명, security.md §섹션명 해당 시]
